...
- Итоговый вес clamp [0.05, **1.8**]: чтобы прогрессия к mastery не занимала вечность, максимум поднят с 1.2 до 1.8 (один evidence с весом 1.8 всё равно даёт ограниченный сдвиг Beta при cap α+β=12).
