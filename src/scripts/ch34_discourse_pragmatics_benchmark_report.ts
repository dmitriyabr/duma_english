...
async function main() {
  ...
  const outputPath =
    ...
    "docs/reports/CH34_DISCOURSE_PRAGMATICS_BENCHMARK_REPORT.json";
    ...
    JSON.stringify(
      {
        ...
        summary: {
          ...
          discourseAttempts: report.discourseAttempts,
          engineCoverageCount: report.engineCoverageCount,
          engineCoverageRate: report.engineCoverageRate,
          overallAgreementRate: report.overallAgreementRate,
        },
      },
      null,
      2,
