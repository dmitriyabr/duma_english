...
import { buildRetentionPromotionBlockerReport } from "../lib/quality/retentionPromotionBlockerReport";
...
async function main() {
  ...
  const report = await buildRetentionPromotionBlockerReport({
    windowDays,
    limit,
  });
    ...
    JSON.stringify(
      {
        ...
        summary: {
          totalAudits: report.totalAudits,
          blockedByRetentionCount: report.blockedByRetentionCount,
          blockedByRetentionRate: report.blockedByRetentionRate,
          highStakesRetentionBlockedRate: report.highStakesRetentionBlockedRate,
        },
      },
      null,
      2,
